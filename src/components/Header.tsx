      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-white hover:text-xanh-duongnhat transition-colors">
              Trang chủ
            </a>
            <a href="#" className="text-white hover:text-xanh-duongnhat transition-colors">
              Tìm vé
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-xanh-duongdam py-4">
            <nav className="flex flex-col space-y-3">
              <a href="#" className="text-white hover:text-xanh-duongnhat transition-colors px-2 py-2">
                Trang chủ
              </a>
              <a href="#" className="text-white hover:text-xanh-duongnhat transition-colors px-2 py-2">
                Tìm vé
              ...
              <button className="bg-do hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-all mt-3 mx-2">
                Đăng nhập
              </button>
            </nav>
          </div>
